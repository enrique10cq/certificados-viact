...
<body>
   ...
   $certificados = obtenerCertificado($conexion);
   $totalCertificados = $certificados->num_rows;
   ?>
         ...
         <div class="col col-md-12">
            <div class="text-center">
               <span class="float-start">
                  <button onclick="modalRegistrarEmpleado()" class="btn btn-success" title="Registrar Certificados">
                     <i class="bi bi-person-plus"></i>
                  </button>
               </span>
               <h2>Total Certificados (<?php echo $totalCertificados ?>)</h2>
